...
public class ChangeCoborrower extends AbstractWriter<Coborrower> {

    // Log4J2
    private static final Logger logger = LogManager.getLogger(ChangeCoborrower.class);
    ...
    public String add(Connection conn, Coborrower co, String loanID) {
        ...
        return processRequest(conn, newCo, co, status -> {
            logger.info(
                    "Coborrower {} updated for Loan ID {}, Transaction ID {}",
    ...
    protected Map<String, String> extractLogProperties(Coborrower co, String loanID) {
        ...
        properties.put("number", co.getNumber().toString());
        return properties;
    }
}
